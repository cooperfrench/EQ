...
void ParaEqAudioProcessor::updatePeakFilter(const ChainSettings &chainSettings)
{
...
void ParaEqAudioProcessor::updateCoefficients(Coefficients& old, const Coefficients& replacements)
{
    *old = *replacements;
